					...
					<div class="card-body">
						<form action="{{ route('book.update',$book->id) }}" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-md-7">
									<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name')?old('name'):$book->name }}" required autocomplete="title" autofocus>
									@error('name')
							...
							<div class="form-group row authors">
								<label for="author_book" class="col-md-3 col-form-label text-md-right">Author</label>
